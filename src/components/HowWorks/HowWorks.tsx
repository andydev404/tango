      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <motion.h2
            ...
            className="font-serif text-3xl font-bold tracking-tight text-black sm:text-4xl md:text-6xl"
          >
            ¿CÓMO FUNCIONA?
          </motion.h2>
          <motion.p
            {...opacityAnimationProps}
            className="mt-6 text-lg tracking-tight text-black"
          >
        ...
        >
          {({ selectedIndex }) => (
            <>
              ...
              <motion.div {...slideUpAnimationProps}>
